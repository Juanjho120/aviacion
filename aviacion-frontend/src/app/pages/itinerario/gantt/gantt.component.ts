...
export class GanttComponent implements OnInit {
  ...
  displayedColumns = ['operador', 'numero', '00:00', '00:15', '00:30', '00:45', '01:00', '01:15', '01:30', '01:45', '02:00', '02:15', 
                      '02:30', '02:45', '03:00', '03:15', '03:30', '03:45', '04:00', '04:15', '04:30', '04:45', '05:00', '05:15', 
  ...
  buscar() {
    this.vueloService.getByFechaIngreso(this.fechaFormato).subscribe(data => {
